	...
	<body class="bg-gray-700">
		...
		<nav class="bg-gray-800 shadow-lg">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					<li class="active"><a href="{{ route('index') }}" class="block text-sm px-2 py-4    hover:bg-green-500 transition duration-300 text-gray-300
						{{ (request()->is('/')) ? 'active-mobile' : '' }}
						">Home</a></li>
					<li><a href="{{ route('servicos') }}" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 text-gray-300
						{{ (request()->is('servicos')) ? 'active-mobile' : '' }}
						">Serviços</a></li>
					<li><a href="{{ route('sobre') }}" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 text-gray-300
				...
				<form action="{{ route('pesquisa') }}" method="get" class="px-2 py-4">
					@csrf 
